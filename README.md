# Awesome Collision Detection with stars
...
* 🟢 [Bullet](http://bulletphysics.org) - Real-time physics SDK with collision detection for games, robotics, and simulation. [⭐ 14.5k](https://github.com/bulletphysics/bullet3) ⭐ 14,670 | 🐛 423 | 🌐 C++ | 📅 2025-10-22
* 🟢 [MuJoCo](https://mujoco.org/) - Physics simulator with contact, collision, and distance queries for robotics and control. [⭐ 13.4k](https://github.com/google-deepmind/mujoco) ⭐ 14,540 | 🐛 379 | 🌐 C++ | 📅 2026-08-12
* 🟢 [Box2D](https://box2d.org) - 2D physics engine with collision, distance, ray cast, and shape cast queries. [⭐ 9.7k](https://github.com/erincatto/box2d) ⭐ 10,267 | 🐛 29 | 🌐 C | 📅 2026-08-11
* 🟢 tinyc2 - Single-header 2D collision detection library for primitive shapes. [⭐ 5k](https://github.com/RandyGaul/tinyheaders) ⭐ 5,043 | 🐛 25 | 🌐 C | 📅 2026-08-05
* 🟢 [PhysX](https://nvidia-omniverse.github.io/PhysX/) - NVIDIA physics SDK with scene queries, contact generation, and collision detection. [⭐ 4.5k](https://github.com/NVIDIA-Omniverse/PhysX) ⭐ 4,713 | 🐛 72 | 🌐 C++ | 📅 2026-08-07
* 🟡 [ReactPhysics3d](http://www.reactphysics3d.com/) - C++ 3D physics engine with rigid body collision detection. [⭐ 1.7k](https://github.com/DanielChappuis/reactphysics3d) ⭐ 1,772 | 🐛 91 | 🌐 C++ | 📅 2025-03-28
* 🟢 [FCL](https://github.com/flexible-collision-library/fcl) ⭐ 1,747 | 🐛 244 | 🌐 C++ | 📅 2026-06-03 - Flexible Collision Library for collision, distance, and continuous collision queries. [⭐ 1.7k](https://github.com/flexible-collision-library/fcl) ⭐ 1,747 | 🐛 244 | 🌐 C++ | 📅 2026-06-03
...
* 🟢 [Parry](https://github.com/dimforge/parry) ⭐ 854 | 🐛 50 | 🌐 Rust | 📅 2026-08-08 - Rust collision detection and geometric query library from Dimforge. [⭐ 819](https://github.com/dimforge/parry) ⭐ 854 | 🐛 50 | 🌐 Rust | 📅 2026-08-08
...
* 🟢 [coal (HPP-FCL)](https://github.com/coal-library/coal) ⭐ 636 | 🐛 52 | 🌐 C++ | 📅 2026-08-01 - Collision detection and distance query library derived from HPP-FCL. [⭐ 586](https://github.com/coal-library/coal) ⭐ 636 | 🐛 52 | 🌐 C++ | 📅 2026-08-01
...
* 🟢 [python-fcl](https://github.com/BerkeleyAutomation/python-fcl) ⭐ 272 | 🐛 30 | 🌐 Cython | 📅 2026-04-08 - Python bindings for FCL collision, distance, and continuous collision queries. [⭐ 269](https://github.com/BerkeleyAutomation/python-fcl) ⭐ 272 | 🐛 30 | 🌐 Cython | 📅 2026-04-08
* 🟢 [pytorch\_volumetric](https://github.com/UM-ARM-Lab/pytorch_volumetric) ⭐ 251 | 🐛 3 | 🌐 Python | 📅 2026-07-07 - PyTorch utilities for volumetric signed distance fields and differentiable collision queries. [⭐ 246](https://github.com/UM-ARM-Lab/pytorch_volumetric) ⭐ 251 | 🐛 3 | 🌐 Python | 📅 2026-07-07
* 🟢 [OpenGJK](https://www.mattiamontanari.com/opengjk/) - GJK-based minimum distance library with bindings for multiple languages. [⭐ 197](https://github.com/MattiaMontanari/openGJK) ⭐ 205 | 🐛 2 | 🌐 C++ | 📅 2026-04-30
* 🟢 [Tight-Inclusion](https://continuous-collision-detection.github.io/tight_inclusion/) - Conservative continuous collision detection library with minimum separation support. [⭐ 157](https://github.com/Continuous-Collision-Detection/Tight-Inclusion) ⭐ 160 | 🐛 0 | 🌐 C++ | 📅 2026-08-06
...
* 🟢 [Kraft](https://github.com/BeRo1985/kraft) ⭐ 128 | 🐛 6 | 🌐 Pascal | 📅 2026-08-09 - Object Pascal physics engine with discrete and optional continuous collision detection. [⭐ 126](https://github.com/BeRo1985/kraft) ⭐ 128 | 🐛 6 | 🌐 Pascal | 📅 2026-08-09
...
* 🟢 [CoACD](https://colin97.github.io/CoACD/) - Approximate convex decomposition for collision-aware mesh approximation. [⭐ 1k](https://github.com/SarahWeiii/CoACD) ⭐ 1,125 | 🐛 34 | 🌐 C++ | 📅 2026-05-04
* 🟢 cinolib - A generic programming header only C++ library for processing polygonal and polyhedral meshes. [⭐ 1.1k](https://github.com/mlivesu/cinolib) ⭐ 1,108 | 🐛 5 | 🌐 C++ | 📅 2026-06-15
...
* GJK++: Leveraging Acceleration Methods for Faster Collision Detection (2023), Montaut et al. \[[pdf](https://hal.science/hal-04070039v1/document), [code](https://github.com/humanoid-path-planner/hpp-fcl) ⭐ 636 | 🐛 52 | 🌐 C++ | 📅 2026-08-01, [benchmarks](https://github.com/lmontaut/colbench) ⭐ 19 | 🐛 0 | 🌐 C++ | 📅 2023-07-03]
* Collision Detection Accelerated: An Optimization Perspective (2022), Montaut et al. \[[pdf](https://hal.archives-ouvertes.fr/hal-03662157/document), [code](https://github.com/humanoid-path-planner/hpp-fcl) ⭐ 636 | 🐛 52 | 🌐 C++ | 📅 2026-08-01, [benchmarks](https://github.com/lmontaut/collision-detection-benchmark) ⭐ 30 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-07-07]
...
* Differentiable Collision Detection: a Randomized Smoothing Approach (2022), Montaut et al. \[[pdf](https://hal.archives-ouvertes.fr/hal-03780482v2/document), [code](https://github.com/humanoid-path-planner/hpp-fcl) ⭐ 636 | 🐛 52 | 🌐 C++ | 📅 2026-08-01]

#### Triangle-triangle Test

* Faster Triangle-Triangle Intersection Tests (2006), O. Devillers et al. \[[pdf](https://hal.inria.fr/inria-00072100/document), [code](https://github.com/CGAL/cgal/blob/076c982dbf37cc244206fd7962e73360fb17ea47/Intersections_3/include/CGAL/Triangle_3_Triangle_3_do_intersect.h) ⭐ 6,009 | 🐛 684 | 🌐 C++ | 📅 2026-08-12]
...
* Approximate Convex Decomposition for 3D Meshes with Collision-Aware Concavity and Tree Search (2022), X. Wei et al. \[[pdf](https://arxiv.org/pdf/2205.02961), [project](https://colin97.github.io/CoACD/), [code](https://github.com/SarahWeiii/CoACD) ⭐ 1,125 | 🐛 34 | 🌐 C++ | 📅 2026-05-04, [video](https://www.youtube.com/watch?v=r12O0z0723s)]
...
* Fast Approximate Nearest Neighbors with Automatic Algorithm Configuration (2009), M. Muja and D. Lowe. \[[pdf](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.160.1721\&rep=rep1\&type=pdf), [code](https://github.com/mariusmuja/flann) ⭐ 2,373 | 🐛 298 | 🌐 C++ | 📅 2024-07-29]
* Faster cover tree (2015), M. Izbicki et al. \[[pdf](http://proceedings.mlr.press/v37/izbicki15.pdf), [code](https://github.com/manzilzaheer/CoverTree) ⭐ 95 | 🐛 8 | 🌐 C++ | 📅 2020-06-16]
* Cover Tree for Nearest Neighbor (2006), A. Beygelzimer et al. \[[pdf](https://homes.cs.washington.edu/~sham/papers/ml/cover_tree.pdf), [web](http://hunch.net/~jl/projects/cover_tree/cover_tree.html), [code](https://github.com/DNCrane/Cover-Tree) ⭐ 64 | 🐛 5 | 🌐 C++ | 📅 2018-02-13]

#### Comprehensive Collision Detection Library

* FCL: A General Purpose Library for Collision and Proximity Queries (2012), J. Pan et al. \[[pdf](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.259.2177\&rep=rep1\&type=pdf), [code](https://github.com/flexible-collision-library/fcl) ⭐ 1,747 | 🐛 244 | 🌐 C++ | 📅 2026-06-03]
...
* [spatial-collision-datastructures](https://github.com/ttvd/spatial-collision-datastructures) ⚠️ Archived - Benchmark of various spatial data structures for collision detection.
...
* [Benchmark of various spatial data structures for collision detection](https://github.com/ttvd/spatial-collision-datastructures) ⚠️ Archived
* Bounding volume hierarchy
  * [Bounding Volume Hierarchy Optimization through Agglomerative Treelet Restructuring](http://www.highperformancegraphics.org/wp-content/uploads/2015/Papers-Session1/apresentacao.pdf) ([paper](http://dl.acm.org/citation.cfm?id=2790065), [code](https://github.com/leonardo-domingues/atrbvh) ⭐ 56 | 🐛 0 | 🌐 C++ | 📅 2015-07-25) by Leonardo R. Domingues and Helio Pedrini.
...
* [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,013 | 🐛 15 | 🌐 Python | 📅 2026-08-06 [⭐ 2.9k](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,013 | 🐛 15 | 🌐 Python | 📅 2026-08-06 - This is a list of various libraries and software for robotics. It's also attempting to provide some comparisons for selected libraries and software.

## [Contributing](#contents)

Contributions are very welcome! Please read the [contribution guidelines](https://github.com/jslee02/awesome-collision-detection/blob/main/CONTRIBUTING.md) ⭐ 1,039 | 🐛 3 | 🌐 Python | 📅 2026-08-10 first. Also, please feel free to report any error.
